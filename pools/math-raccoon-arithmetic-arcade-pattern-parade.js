...
MR.Pools.register({
  ...
  "questions": [
    ...
    { "kind": "functionTable",
      "prompt": "The machine's rule is +4. Drop the right OUT into each row.",
      "rule":   { "op": "+", "n": 4 },
      "rows":   [{ "in": 1, "out": null }, { "in": 2, "out": null }, { "in": 3, "out": null }],
      "tokens": ["5", "6", "7", "4", "8"],
      "answer": ["5", "6", "7"],
      "hint": "1+4=5, 2+4=6, 3+4=7." },

    { "kind": "functionTable",
      "prompt": "The machine's rule is ×3. Drop the right OUT into each row.",
      "rule":   { "op": "×", "n": 3 },
      "rows":   [{ "in": 2, "out": null }, { "in": 3, "out": null }, { "in": 4, "out": null }],
      "tokens": ["6", "9", "12", "8", "10"],
      "answer": ["6", "9", "12"],
    ...
    { "kind": "functionTable",
      "prompt": "The machine's rule is ×5. Drop the right OUT into each row.",
      "rule":   { "op": "×", "n": 5 },
      "rows":   [{ "in": 2, "out": null }, { "in": 4, "out": null }, { "in": 6, "out": null }],
    ...
    { "kind": "functionTable",
      "prompt": "The machine's rule is +10. Drop the right OUT into each row.",
      "rule":   { "op": "+", "n": 10 },
      "rows":   [{ "in": 3, "out": null }, { "in": 5, "out": null }, { "in": 8, "out": null }],
    ...
    { "kind": "functionTable",
      "prompt": "The machine's rule is −3. Drop the right OUT into each row.",
      "rule":   { "op": "−", "n": 3 },
      "rows":   [{ "in": 7, "out": null }, { "in": 10, "out": null }, { "in": 12, "out": null }],
      "tokens": ["4", "7", "9", "5", "11"],
      "answer": ["4", "7", "9"],
    ...
    { "kind": "functionTable",
      "prompt": "The machine's rule is ×2. Drop the right OUT into each row.",
      "rule":   { "op": "×", "n": 2 },
      "rows":   [{ "in": 4, "out": null }, { "in": 6, "out": null }, { "in": 8, "out": null }],
      "tokens": ["8", "12", "16", "10", "14"],
      "answer": ["8", "12", "16"],
    ...
    { "kind": "functionTable",
      "prompt": "The machine's rule is +6. Drop the right OUT into each row.",
      "rule":   { "op": "+", "n": 6 },
      "rows":   [{ "in": 2, "out": null }, { "in": 5, "out": null }, { "in": 9, "out": null }],
    ...
    // ---- REVERSE: machine runs backwards (rule + OUT → IN) -----------------
    { "kind": "functionTable",
      "prompt": "🔍 Reverse: the rule is +5. Drop the right IN that made each OUT.",
      "rule":   { "op": "+", "n": 5 },
      "rows":   [{ "in": null, "out": 8 }, { "in": null, "out": 11 }, { "in": null, "out": 14 }],
      "tokens": ["3", "6", "9", "5", "7"],
      "answer": ["3", "6", "9"],
      "hint": "Undo the +5 by subtracting 5: 8−5=3, 11−5=6, 14−5=9." },

    { "kind": "functionTable",
      "prompt": "🔍 Reverse: rule is ×4. What IN gives each OUT?",
      "rule":   { "op": "×", "n": 4 },
      "rows":   [{ "in": null, "out": 8 }, { "in": null, "out": 12 }, { "in": null, "out": 20 }],
      "tokens": ["2", "3", "5", "4", "6"],
      "answer": ["2", "3", "5"],
      "hint": "Undo the ×4 by dividing: 8÷4=2, 12÷4=3, 20÷4=5." },

    { "kind": "functionTable",
      "prompt": "🔍 Reverse: rule ×10. Find the IN for each OUT.",
      "rule":   { "op": "×", "n": 10 },
      "rows":   [{ "in": null, "out": 40 }, { "in": null, "out": 70 }, { "in": null, "out": 90 }],
      "tokens": ["4", "7", "9", "5", "8"],
      "answer": ["4", "7", "9"],
      "hint": "Drop the zero: 40→4, 70→7, 90→9." },

    { "kind": "functionTable",
      "prompt": "🔍 Reverse: rule −2. Find the IN that gives each OUT.",
      "rule":   { "op": "−", "n": 2 },
      "rows":   [{ "in": null, "out": 5 }, { "in": null, "out": 8 }, { "in": null, "out": 11 }],
      "tokens": ["7", "10", "13", "6", "9"],
      "answer": ["7", "10", "13"],
      "hint": "Undo the −2 by adding 2: 5+2=7, 8+2=10, 11+2=13." },
  ],
});
