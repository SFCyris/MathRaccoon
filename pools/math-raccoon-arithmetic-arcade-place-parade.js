...
MR.Pools.register({
  ...
  "questions": [
    ...
    { "mode": "read", "n": 184, "placeIdx": 0, "hint": "Ones = rightmost digit." },
    { "mode": "read", "n": 256, "placeIdx": 1, "hint": "Tens column." },
    { "mode": "read", "n": 421, "placeIdx": 2, "hint": "Hundreds column." },
    { "mode": "read", "n": 503, "placeIdx": 1, "hint": "Tens column — there's a 0 to watch." },
    { "mode": "read", "n": 862, "placeIdx": 2, "hint": "Hundreds column." },

    { "mode": "expanded", "n": 234, "hint": "200 + 30 + 4." },
    { "mode": "expanded", "n": 506, "hint": "500 + 0 + 6. Zero tens!" },
    { "mode": "expanded", "n": 284, "hint": "200 + 80 + 4." },
    { "mode": "expanded", "n": 370, "hint": "300 + 70 + 0." },
    { "mode": "expanded", "n": 406, "hint": "400 + 0 + 6." },
    { "mode": "expanded", "n": 789, "hint": "700 + 80 + 9." },
    { "mode": "expanded", "n": 912, "hint": "900 + 10 + 2." },
    ...
    { "mode": "round", "n": 134, "toPlace": 100, "hint": "Tens digit 3 → round down to 100." }
  ]
});
