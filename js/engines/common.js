/**
 * common.js — shared utilities for game engines.
 * Engines produce problems + renderings; games wire them into rounds.
 */
(function () {
  ...
  // For fraction options — allow fractional distractors
