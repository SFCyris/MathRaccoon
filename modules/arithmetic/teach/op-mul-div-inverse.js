    ...
    strategies: [
      {
        ...
        watchMe: [
          ...
          { text: "Counting dots: 2 × 5 = 10.",
            equation: "2 × 5 = 10" },
          { text: "Look at the same 10 dots arranged as 2 rows. How many per row?",
        ...
        practice: [
          ...
          },
          {
            ...
            viz: { type: "array", params: { rows: 5, cols: 3, label: "5 × 3 = 15" } },
            options: [3, 5, 15],
            answer: 5,
      ...
      },
      {
        ...
        practice: [
          ...
          },
          {
            ...
            viz: { type: "array", params: { rows: 9, cols: 2, label: "9 × 2 = 18" } },
            options: [2, 4, 9],
            answer: 2,
      ...
      },
      {
        ...
        practice: [
          {
            prompt: "Tap a gap between rows to split 6 × 8 into a 5-row piece and a 1-row piece. Then pick the total.",
            viz: { type: "breakApartArray", params: { rows: 6, cols: 8, splitTarget: 5, label: "Tap a gap between rows to split. The colored pieces show the two products." } },
            options: [40, 45, 48],
            answer: 48,
            hint: "Look at the two colored pieces. Add the two products to get the total.",
          },
          {
            prompt: "Tap a gap to split 9 × 4 into a 5-row piece and a 4-row piece. Then pick the total.",
            viz: { type: "breakApartArray", params: { rows: 9, cols: 4, splitTarget: 5, label: "Tap a gap between rows to split. The colored pieces show the two products." } },
            options: [32, 36, 40],
            answer: 36,
            hint: "Look at the two colored pieces. Add the two products to get the total.",
          },
