    ...
    strategies: [
      {
        ...
        practice: [
          ...
          {
            prompt: "11 − 3 = ?",
            viz: { type: "numberLine", params: { min: 5, max: 13, at: 11 } },
            options: [7, 8, 9],
            answer: 8,
      ...
      },
      {
        ...
        practice: [
          ...
          {
            prompt: "14 − 9 = ?",
            viz: { type: "numberLine", params: { min: 7, max: 16, at: 9 } },
            options: [4, 5, 6],
            answer: 5,
      ...
      },
      {
        ...
        subtitle: "Use the related addition fact.",
        emoji: "🔄",
        idea: {
        ...
        practice: [
          {
            ...
            viz: { type: "barModel", params: { whole: 16, parts: [{ value: 9, label: "9" }, { value: 7, label: "?" }] } },
            options: [6, 7, 8],
            answer: 7,
          },
          {
            prompt: "14 − 6 = ? Think: 6 + ? = 14.",
            viz: { type: "barModel", params: { whole: 14, parts: [{ value: 6, label: "6" }, { value: 8, label: "?" }] } },
            options: [7, 8, 9],
            answer: 8,
          },
        ],
